          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <motion.button
                ...
                className="w-full flex justify-center py-2 px-4 bg-gray-700 rounded-lg border border-gray-600 text-gray-300 hover:bg-gray-600 transition"
                whileHover={{ y: -2 }}
              >
              ...
              className="w-full flex items-center justify-center px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm bg-white dark:bg-dark-700 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-dark-600 transition-all duration-200"
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
            >
