...
// const MinimalistTemplate = ({ user, projects, sectionOrder, visibleSections }) => {
...
//       skills: ['React', 'Node.js', 'MongoDB', 'Express', 'TypeScript', 'PostgreSQL'],
...
//       icon: Database,
//       description: 'Specializing in MongoDB, Express.js, React, and Node.js for full-stack development.',
...
//       icon: Cloud,
//       description: 'Streamlining development workflows with CI/CD, cloud infrastructure, and automation.',
...
//       icon: Cpu,
//       description: 'Developing intelligent applications using machine learning and artificial intelligence.',
//       skills: ['Python', 'TensorFlow', 'PyTorch', 'Scikit-learn', 'OpenAI', 'Pandas'],
...
//                     <div className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${specializations.find(s => s.id === selectedSpecialization)?.color} flex items-center justify-center shadow-lg`}>
//                       {React.createElement(specializations.find(s => s.id === selectedSpecialization)?.icon || Code, {
...
//                     {specializations.find(s => s.id === selectedSpecialization)?.description}
//                   </p>

//                   {/* Core Technologies */}
//                   <div className="text-center">
//                     <h4 className="text-lg font-medium text-gray-900 mb-4">Core Technologies</h4>
//                     <div className="flex flex-wrap justify-center gap-3">
//                       {specializations.find(s => s.id === selectedSpecialization)?.skills.map((skill, index) => (
//                         <motion.span
//                           key={skill}
...
//                     Creating innovative solutions that solve real-world problems and deliver exceptional user experiences.
//                   </p>
//                 </motion.div>
...
//                   <p className="text-gray-600 text-sm leading-relaxed">
//                     Combining cutting-edge technology with clean, maintainable code and agile development practices.
//                   </p>
//                 </motion.div>
...
//                   <p className="text-gray-600 text-sm leading-relaxed">
//                     Passionate about continuous learning, mentoring others, and contributing to the developer community.
//                   </p>
//                 </motion.div>
//               </div>
//             </div>
...
//                       <Calendar className="w-4 h-4 mr-2" />
//                       <span className="text-sm">{edu.startYear} {edu.startYear && edu.endYear && '-'} {edu.endYear}</span>
//                     </div>
//                   </motion.div>
//                 ))}
//               </div>
...
//                 exit={{ opacity: 0, y: -30 }}
//                 transition={{ duration: 0.5 }}
//                 className="bg-gray-50 rounded-2xl p-8 shadow-lg border border-gray-100 mb-8 relative"
//               >
...
const MinimalistTemplate: React.FC<TemplateProps> = ({ user, projects, sectionOrder, visibleSections }) => {
  const [activeSection, setActiveSection] = useState('hero');
  const [mousePosition, setMousePosition] = useState({ x: 0, y: 0 });
  const [isScrolled, setIsScrolled] = useState(false);
        ...
        return user.testimonials && user.testimonials.length > 0 ? (
          <section id="testimonials" className="py-20 bg-gray-50">
            <div className="max-w-4xl mx-auto px-8">
              ...
              {/* Testimonial navigation */}
              <div className="flex justify-center space-x-2">
                {user.testimonials.map((_: any, index: number) => (
                  <button
                    key={index}
                    onClick={() => setCurrentTestimonial(index)}
                    className={`w-3 h-3 rounded-full transition-all duration-300 ${
