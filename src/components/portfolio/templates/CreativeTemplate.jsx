  ...
  const renderSection = (sectionId) => {
   const isVisible = visibleSections[sectionId]
    ...
    switch (sectionId) {
          ...
          <InteractiveBackground className={`relative min-h-screen bg-gradient-to-br ${themes[currentTheme]} overflow-hidden`}>
            ...
            <div className="relative z-10 flex items-center justify-center min-h-screen px-4">
              <div className="text-center">
                ...
                >
                  <motion.span
                    // animate={{ color: ['#ffffff', '#ff6b9d', '#c44569', '#ffffff'] }}
                    // transition={{ duration: 3, repeat: Infinity }}
                  >
      ...
      case 'skills':
        return user.skills && user.skills.length > 0 ? (
          <InteractiveBackground className="py-20 bg-black relative overflow-hidden">
            <div 
      ...
      case 'education':
        return user.education && user.education.length > 0 ? (
          <InteractiveBackground className="py-20 bg-gradient-to-br from-violet-600 via-purple-600 to-blue-600 relative overflow-hidden">
            <div 
      ...
      case 'certifications':
        return user.certifications && user.certifications.length > 0 ? (
          <InteractiveBackground className="py-20 bg-gradient-to-br from-orange-400 via-pink-500 to-red-600 relative overflow-hidden">
            <div 
              className="absolute inset-0 opacity-15"
              style={{
      ...
      case 'testimonials':
        return user.testimonials && user.testimonials.length > 0 ? (
          <InteractiveBackground className="py-20 bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 relative overflow-hidden">
            <div 
              className="absolute inset-0 opacity-15"
              style={{
      ...
      case 'projects':
        return projects && projects.length > 0 ? (
          <InteractiveBackground className="py-20 bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 relative overflow-hidden">
            <div 
              className="absolute inset-0 opacity-10"
              style={{
                          ...
                          {project.techStack.map((tech, techIndex) => (
                            <motion.span
                              ...
                              className={`px-3 py-1 rounded-full text-sm font-bold text-white cursor-pointer ${
                                techIndex % 3 === 0 ? 'bg-pink-500/50 hover:bg-pink-500/70' :
                                techIndex % 3 === 1 ? 'bg-purple-500/50 hover:bg-purple-500/70' :
   ...
   case 'contact':
        return (
          <InteractiveBackground className="py-20 bg-gradient-to-br from-yellow-400 via-red-500 to-pink-500 relative overflow-hidden">
            <div 
              className="absolute inset-0 opacity-20"
              style={{
